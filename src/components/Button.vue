<template>
  ...
  <div class="ml-2.5 group" v-else>
    <span class="-border absolute text-3xl text-blue-600 font-normal ml-1 -mt-1 cursor-pointer group-hover:z-10">
      +
    </span>
    <button
